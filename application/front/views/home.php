...
?>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel">
		...
		<div class="carousel-inner" role="listbox">
            ...
            foreach($slider as $key => $val){
                $active = $key == 0 ? "active" : "";
                $item = $key == 0 ? "active" : "item".($key)+1 ;
                $slider_html =
                '<div class="item '.$item.'" style="background: linear-gradient(rgba(23, 22, 23, 0.2), rgba(23, 22, 23, 0.5)), url('.SITEURL.$val['image'].') no-repeat;">';
                $slider_html .= '
                    <div class="container">
                        <div class="carousel-caption">';
                $slider_html .= '<h3>'.$val["title"].'</h3>';
                $slider_html .= '<p>'.$val["tag_line"].'</p>';
                $slider_html .= '<a class="button2" href="'.$val["link"].'">Shop Now </a>';
                $slider_html .= '
                        </div>
                    </div>
                </div>';
