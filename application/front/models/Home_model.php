...
class Home_model extends Data {
    ...
    public $tbl_user_payment_type = "user_payment_type";
	public $tbl_client_bank_details = "client_bank_details";
	public $tbl_card_type = "card_type";
