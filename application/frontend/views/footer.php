...
Copyright &copy; <?php echo date("Y"); ?> All rights reserved jaitra gems | Developed by <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="" target="_blank">YK11</a>
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. --></p>
  ...
  <script src="<?php echo base_url('assets/frontend/vendors/jquery-ui/jquery-ui.js'); ?>"></script>
  ...
  <script src="<?php echo base_url('assets/frontend/vendors/counter-up/jquery.waypoints.min.js'); ?>"></script>
  <script src="<?php echo base_url('assets/frontend/vendors/counter-up/jquery.counterup.js'); ?>"></script>
  ...
  <?php echo isset($footer_assets) && $footer_assets != "" ? $footer_assets : ""; ?>
</body>
</html>