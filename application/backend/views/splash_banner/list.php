...
echo form_open_multipart('splash_slider', $attributes);
?>
			<!-- begin breadcrumb -->
            ...
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("splash_slider/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                            ...
                            <td>
                            	<div class="media">
                                    <a class="media-left" href="javascript:;">
                                        <img src="<?php echo file_check($rec["file"]); ?>" alt="" class="media-object img-rounded" style="width:60px; height:60px; object-fit:cover;">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="<?php echo base_url("splash_slider/form/".$rec["id"]) ?>"><?php echo $rec["title"]; ?></a></h4>
                                        <p>Type : <?php echo ucwords($rec["type"]); ?></p>
                                    </div>
                                </div>
                            </td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'splash_slider/delete');
			$('#frm_add').submit()	
		}
	}
}
