...
echo form_open_multipart('state', $attributes);
?>
			<!-- begin breadcrumb -->
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">State - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("state/AddState"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
			...
			<div class="section-container section-with-top-border">
                ...
                <div class="panel pagination-inverse clearfix m-b-0">
                    ...
                    <table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        ...
                        ?>
                        <tr class="<?php echo $row;?>" id="row_<?php echo $rec["state_id"]; ?>" data-val="<?php echo $rec["state_id"]; ?>">
                            <td><input type="checkbox" name="record[]" value="<?php echo $rec["state_id"]; ?>" /></td>
                            <td><a href="<?php echo base_url("state/AddState/".$rec["state_id"]) ?>"><?php echo $rec["state_name"]; ?></a></td>
                            <td><?php echo $rec["state_code"]; ?></td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'state/delete');
			$('#frm_add').submit()	
		}
	}
}
