...
?>
            ...
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("banner/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                            ...
                            <td>
                            	<div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="<?php echo base_url("banner/form/".$rec["id"]) ?>"><?php echo $rec["title"]; ?></a></h4>
                                        <?php echo $rec["url"] == "" ? "" : '<p><a target="_blank" href="'.$rec["url"].'">'.$rec["url"].'</a></p>'; ?>
                                    </div>
                                </div>
                            </td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'banner/delete');
			$('#frm_add').submit()	
		}
	}
}
