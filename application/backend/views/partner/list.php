...
?>
			...
			<h1 class="page-header">Partner - List <!--<small>header small text goes here...</small>--></h1>
			...
			<p class="m-b-0">
                ...
                <a href="<?php echo base_url("partner/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                    ...
                    <table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        ...
                        <tr class="<?php echo $row;?>" id="row_<?php echo $rec["id"]; ?>" data-val="<?php echo $rec["id"]; ?>">
                            ...
                            <td>
                            	...
                            	<img class="profile-img" src="<?php echo file_check($rec["profile"]); ?>" /> 

                                <a href="<?php echo base_url("partner/form/".$rec["id"]) ?>"><?php echo $rec["name"]; ?></a>
                            ...
                            <td><a href="<?php echo base_url('partner/services/'.$rec['id']);?>">Add Services</a></td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			...
			$('#frm_add').attr('action',BASE_URL+'partner/delete');
