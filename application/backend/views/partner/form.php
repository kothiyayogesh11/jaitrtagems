...
<div id="content" class="content">
			...
			<h1 class="page-header">Add Partner<!--<small>header small text goes here...</small>--></h1>
			...
			<div class="section-container section-with-top-border">
				...
				echo form_open_multipart('partner/process', $attributes);
				...
				?>
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-form-label col-sm-3" for="business_name">Business name <span class="text-danger">*</span></label>

                        <div class="col-sm-6">

                            <input class="form-control required" type="text" id="business_name" value="<?php echo @$rsEdit->business_name; ?>" name="business_name" placeholder="Business name" />
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-form-label col-sm-3" for="training_type">Training Type <span class="text-danger">*</span></label>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select id="training_type" class="form-control required selectpicker" autocomplete="false" name="training_type" data-size="10" data-live-search="true" data-style="btn-default picker-btn">
                                ...
                                <?php
                                	...
                                	echo $this->page->generateComboByTable("pets_training_type","id","type","","WHERE delete_flag = 0",@$rsEdit->training_type,"Select Type");
...
$(document).ready(function(e) {
	...
	$("#training_type").selectpicker("render");
...
$(document).on("blur","#email",function(){
	...
	if(data_post.email != "" && email_test){
		...
		$.ajax({
			...
			url:BASE_URL+"partner/type_check_email",
...
$(document).on("change","#country",function(){
	...
	if($obj.val() != null && $obj.val() != ""){
		...
		$.ajax({
			...
			url:BASE_URL+"partner/get_state",
