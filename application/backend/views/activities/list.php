...
echo form_open_multipart('activities', $attributes);
?>
			<!-- begin breadcrumb -->
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Activities - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("activities/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                            ...
                            <td>
                            	<div class="media">
                                    <a class="media-left" href="javascript:;">
                                        <img src="<?php echo SITEURL.$rec["image"]; ?>" alt="" class="media-object img-rounded" style="width:90px; height:90px; object-fit:cover;">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="<?php echo base_url("activities/form/".$rec["id"]) ?>"><?php echo $rec["title"]; ?></a></h4>
                                        <p><?php echo $rec["description"]; ?></p>
                                    </div>
                                </div>
                            </td>
                            <!--<td><?php echo $rec["category_title"]; ?></td>-->
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'activities/delete');
			$('#frm_add').submit()	
		}
	}
}
