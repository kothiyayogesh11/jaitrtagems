...
?>
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item"><a href="javascript:;">Web Banners</a></li>
				<li class="breadcrumb-item"><a href="javascript:;">List</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Banners - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("web_slider/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                            ...
                            <td>
                            	<div class="media">
                                    <a class="media-left" href="javascript:;">
                                        <img src="<?php echo file_check($rec["image"]); ?>" alt="" class="media-object img-rounded" style="width:50px; height:50px; object-fit:fill;">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="<?php echo base_url("web_slider/form/".$rec["id"]) ?>"><?php echo $rec["title"]; ?></a></h4>
                                        <?php echo $rec["link"] == "" ? "" : '<p><a target="_blank" href="'.$rec["link"].'">'.$rec["link"].'</a></p>'; ?>
                                    </div>
                                </div>
                            </td>
                            <td><?php echo $rec["tag_line"]; ?></td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'web_slider/delete');
			$('#frm_add').submit()	
		}
	}
}
