...
?>
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Pets - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                ...
                <div class="panel pagination-inverse clearfix m-b-0">
                    ...
                    <table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        ...
                        <tr class="<?php echo $row;?>" id="row_<?php echo $rec["id"]; ?>" data-val="<?php echo $rec["id"]; ?>">
                            ...
                            <td><img class="profile-img" src="<?php echo file_check($rec["pet_image"],"pets"); ?>"> <?php echo $rec["pet_name"]; ?></td>
                            <td><?php echo $rec["client_name"]; ?></td>
                            <td><?php echo $rec["age"]; ?></td>
                            <td><?php echo $rec["weight"]; ?></td>
                            <td><?php echo $rec["type_name"]; ?></td>
                            <td><?php echo $rec["breed_id"]; ?></td>
