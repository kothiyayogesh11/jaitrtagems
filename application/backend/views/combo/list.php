...
echo form_open_multipart('setting/comboList', $attributes);
?>
			<!-- begin breadcrumb -->
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
				<li class="breadcrumb-item"><a href="javascript:;">Setting</a></li>
				<li class="breadcrumb-item"><a href="javascript:;">Combo List</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Combo - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("setting/AddCombo"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
			...
			<div class="section-container section-with-top-border">
                ...
                <div class="panel pagination-inverse clearfix m-b-0">
                    ...
                    <table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        ...
                        ?>
                        <tr class="<?php echo $row;?>" id="row_<?php echo $rec["combo_id"]; ?>" data-val="<?php echo $rec["combo_id"]; ?>">
                            <td><input type="checkbox" name="record[]" value="<?php echo $rec["combo_id"]; ?>" /></td>
                            <td> 
                                <a href="<?php echo base_url("setting/AddCombo/".$rec["combo_id"]) ?>"><?php echo $rec["combo_case"]; ?></a>
                            </td>
                            <td><?php echo $rec["combo_key"]; ?></td>
                            <td><?php echo $rec["combo_value"]; ?></td>
                            <td><?php echo $rec["seq"]; ?></td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'setting/deleteCombo');
			$('#frm_add').submit()	
		}
	}
}
