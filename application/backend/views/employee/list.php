...
?>
            ...
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("employee/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                    ...
                    <table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        ...
                        <tr class="<?php echo $row;?>" id="row_<?php echo $rec["id"]; ?>" data-val="<?php echo $rec["id"]; ?>">
                            ...
                            <td>
                                ...
                                <a href="<?php echo base_url("employee/form/".$rec["id"]) ?>"><?php echo $rec["name"]; ?></a>
                            </td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'employee/delete');
			$('#frm_add').submit()	
		}
	}
}
