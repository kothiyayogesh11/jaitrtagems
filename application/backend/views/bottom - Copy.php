...
<script src="<?php echo base_url('assets/js/jquery.maskedinput.min.js'); ?>" language="javascript"></script>
...
<script src="<?php echo base_url('assets/js/common.js'); ?>" language="javascript"></script>
<script type="text/javascript">
