                        ...
                        <div id="login-box" class="login-box visible widget-box no-border">
                            <div class="widget-body">
                                <div class="widget-main">
                                    ...
                                    <div class="space-6"></div>
                                    <form name="frmTopLogin" id="frmTopLogin" action="<?php echo base_url('general/login'); ?>" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            <label>
                                ...
                                <div class="widget-main">
                                    ...
                                    <form name="frmRegister" id="frmRegister" action="index.php?c=general&m=register" method="post" enctype="multipart/form-data">
                                        <fieldset>
                                            ...
                                            <label>
                                            <span class="block input-icon input-icon-right">
                                            <input type="text" class="span12 required" name="txtUsername" placeholder="Desired Username" />
                                            <i class="icon-user"></i>
                                            </span>
                                            </label>
                                            <label>
                                            <span class="block input-icon input-icon-right">
                                            <input type="text" class="span12 required" name="txtPhonenumber" placeholder="Phone number" />
                                            <i class="icon-user"></i>
                                            </span>
                                            </label>
                                            <label>
                                            <span class="block input-icon input-icon-right">
                                            <input type="password" name="txtPassword" class="span12 required" placeholder="Password" />
                                            <i class="icon-lock"></i>
                                            </span>
                                            </label>
                                            <label>
                                            <span class="block input-icon input-icon-right">
                                            <input type="password" name="txtCPassword" class="span12 required" placeholder="Repeat password" />
