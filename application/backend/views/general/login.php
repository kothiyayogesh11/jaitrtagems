...
<!-- Mirrored from seantheme.com/source-admin-v1.5/admin/html/extra_login.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 21 Dec 2018 09:14:28 GMT -->
<head>
	<meta charset="utf-8" />
	<title>Jaitra Gems Admin | Login Page</title>
	...
	<div id="page-container" class="fade page-container">
		...
		<div class="login">
            ...
            <div class="login-brand bg-inverse text-white">
                <img src="<?php echo base_url('assets/img/logo-white.png'); ?>" height="36" class="pull-right" alt="" /> Jaitra Gems Admin
            </div>
		    <!-- end login-brand -->
		    <!-- begin login-content -->
            <div class="login-content">
                <h4 class="text-center m-t-0 m-b-20">Great to have you back!</h4>
                <form action="<?php echo base_url("login/login"); ?>" method="POST" name="login_form" class="form-input-flat">
                    <div class="form-group">
                        <input type="text" name="txtUsername" id="txtUsername" class="form-control input-lg" placeholder="Email Address" />
                    </div>
                    <div class="form-group">
