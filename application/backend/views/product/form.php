...
<div id="content" class="content">
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Add Product<!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
			...
			<div class="section-container section-with-top-border">
				...
				echo form_open_multipart('product/process', $attributes);
				...
				?>
                    ...
                    <div class="form-group">
                        <label class="col-form-label col-sm-3 " for="category_id">Price Per Time <span class="text-danger">*</span></label>
                        <div class="col-sm-6">
                            <select id="category_id" class="form-control selectpicker required" autocomplete="false" name="category_id" data-size="10" data-live-search="true" data-style="btn-default picker-btn">
                                <?php
                                echo $this->page->generateComboByTable($this->product->tbl_product_category,"id","name","","WHERE delete_flag = 0 ORDER BY `index` ASC",@$rsEdit->category_id,"Select category");
                                ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" autocomplete="nope" type="text" value="<?php echo @$rsEdit->slug; ?>" id="slug" name="slug" placeholder="i.e unique name" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <input class="form-control" autocomplete="nope" type="text" value="<?php echo @$rsEdit->price; ?>" id="price" name="price" placeholder="i.e 100.00" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <textarea class="form-control required" name="description" id="description"><?php echo @$rsEdit->description; ?></textarea>
                        </div>
                    </div>
...
$(document).on('keypress',"#index, #price",function(e){
