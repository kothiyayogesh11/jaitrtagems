...
echo form_open_multipart('product/category', $attributes);
?>
			<!-- begin breadcrumb -->
			<ol class="breadcrumb pull-right">
				<li class="breadcrumb-item"><a href="<?php echo base_url(); ?>">Home</a></li>
				<li class="breadcrumb-item"><a href="javascript:;">Product</a></li>
				<li class="breadcrumb-item"><a href="javascript:;">Category - List</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Category - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("product/category_form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                            ...
                            <td>
                            	<div class="media">
                                    <a class="media-left" href="javascript:;">
                                        <img src="<?php echo file_check($rec["image"]); ?>" alt="" class="media-object img-rounded" style="width:50px; height:50px; object-fit:cover;">
                                    </a>
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="<?php echo base_url("product/category_form/".$rec["id"]) ?>"><?php echo $rec["name"]; ?></a></h4>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'product/category_delete');
			$('#frm_add').submit()	
		}
	}
}
