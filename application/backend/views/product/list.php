...
echo form_open_multipart('product', $attributes);
?>
			<!-- begin breadcrumb -->
			...
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Product - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("product/form"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                            ...
                            <td>
                            	<div class="media">
                                    ...
                                    <div class="media-body">
                                        <h4 class="media-heading"><a href="<?php echo base_url("product/form/".$rec["id"]) ?>"><?php echo $rec["name"]; ?></a></h4>
                                        <p><?php echo $rec["description"]; ?></p>
                                    </div>
                                </div>
                            </td>
                            <td><?php echo $rec["category_name"]; ?></td>
                            <td><i class="fa fa-dollar-sign"></i> <?php echo $rec["price"]; ?></td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'product/delete');
			$('#frm_add').submit()	
		}
	}
}
