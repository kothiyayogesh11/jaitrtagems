...
?>
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active"><a href="javascript:;">Training Type</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Training Type - List <!--<small>header small text goes here...</small>--></h1>
			<!-- end page-header -->
            <!-- begin nav-pills -->
			<p class="m-b-0">
                <a href="<?php echo base_url("pets/form_training_type"); ?>" class="btn btn-white m-r-5"><i class="fa fa-fw m-r-10 pull-left f-s-18 fa-plus"></i> Add</a>
                ...
                <div class="panel pagination-inverse clearfix m-b-0">
                    ...
                    <table id="data-table" data-order='[[1,"asc"]]' class="table table-bordered table-hover">
                        ...
                        <tr class="<?php echo $row;?>" id="row_<?php echo $rec["id"]; ?>" data-val="<?php echo $rec["id"]; ?>">
                            ...
                            <td><?php echo $i+1; ?></td>
                            <td><a href="<?php echo base_url("pets/form_training_type/".$rec["id"]) ?>"><?php echo $rec["type"]; ?></a></td>
...
function DeleteRow(){
	...
	if(intChecked == 0){
		...
		if(responce==true){
			$('#frm_add').attr('action',BASE_URL+'pets/training_type_delete');
			$('#frm_add').submit()	
		}
	}
}
